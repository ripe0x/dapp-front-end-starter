...
const Home: NextPage = () => {
  ...
  const testTxHash = "0x8fd7e9f06e2120c32f732c95fe3834d7848cd3344cd6c888a971fee1d2fdd138"
  ...
  return (
    <>
      ...
      <OnchainDataExample collectionAddress={testCollectionAddress} chainId={chainId} />

      <hr className='my-8' />

      <h2 className='text-2xl mb-2'>sample onchain data fetching (via viem client)</h2>
